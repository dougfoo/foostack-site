...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha ai.foostack.sa_gui:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name ai.foostack.sa_gui:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines ai.foostack.sa_gui:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground ai.foostack.sa_gui:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ai.foostack.sa_gui:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name ai.foostack.sa_gui:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor ai.foostack.sa_gui:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity ai.foostack.sa_gui:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior ai.foostack.sa_gui:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges ai.foostack.sa_gui:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge ai.foostack.sa_gui:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline ai.foostack.sa_gui:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ai.foostack.sa_gui:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ai.foostack.sa_gui:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name ai.foostack.sa_gui:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority ai.foostack.sa_gui:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts ai.foostack.sa_gui:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy ai.foostack.sa_gui:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout ai.foostack.sa_gui:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage ai.foostack.sa_gui:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery ai.foostack.sa_gui:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ai.foostack.sa_gui:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ai.foostack.sa_gui:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ai.foostack.sa_gui:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ai.foostack.sa_gui:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font ai.foostack.sa_gui:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle ai.foostack.sa_gui:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings ai.foostack.sa_gui:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight ai.foostack.sa_gui:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex ai.foostack.sa_gui:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ai.foostack.sa_gui:font
     */
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ai.foostack.sa_gui:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name ai.foostack.sa_gui:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name ai.foostack.sa_gui:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #LoadingImageView_circleCrop ai.foostack.sa_gui:circleCrop}</code></td><td></td></tr>
     * <tr><td><code>{@link #LoadingImageView_imageAspectRatio ai.foostack.sa_gui:imageAspectRatio}</code></td><td></td></tr>
     * <tr><td><code>{@link #LoadingImageView_imageAspectRatioAdjust ai.foostack.sa_gui:imageAspectRatioAdjust}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link ai.foostack.sa_gui.R.attr#circleCrop}
     * attribute's value can be found in the {@link #LoadingImageView} array.
     *
     * <p>May be a boolean value, such as "<code>true</code>" or
     * "<code>false</code>".
     *
     * @attr name ai.foostack.sa_gui:circleCrop
     */
    public static final int LoadingImageView_circleCrop=0;
    /**
     * <p>This symbol is the offset where the {@link ai.foostack.sa_gui.R.attr#imageAspectRatio}
     * attribute's value can be found in the {@link #LoadingImageView} array.
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name ai.foostack.sa_gui:imageAspectRatio
     */
    public static final int LoadingImageView_imageAspectRatio=1;
    /**
     * <p>This symbol is the offset where the {@link ai.foostack.sa_gui.R.attr#imageAspectRatioAdjust}
     * attribute's value can be found in the {@link #LoadingImageView} array.
     *
     * <p>Must be one of the following constant values.</p>
     * <table>
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:imageAspectRatioAdjust
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SignInButton_buttonSize ai.foostack.sa_gui:buttonSize}</code></td><td></td></tr>
     * <tr><td><code>{@link #SignInButton_colorScheme ai.foostack.sa_gui:colorScheme}</code></td><td></td></tr>
     * <tr><td><code>{@link #SignInButton_scopeUris ai.foostack.sa_gui:scopeUris}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link ai.foostack.sa_gui.R.attr#buttonSize}
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:buttonSize
     */
    public static final int SignInButton_buttonSize=0;
    /**
     * <p>This symbol is the offset where the {@link ai.foostack.sa_gui.R.attr#colorScheme}
     * attribute's value can be found in the {@link #SignInButton} array.
     *
     * <p>May be a reference to another resource, in the form
     * "<code>@[+][<i>package</i>:]<i>type</i>/<i>name</i></code>" or a theme
     ...
     * </table>
     *
     * @attr name ai.foostack.sa_gui:colorScheme
     */
    public static final int SignInButton_colorScheme=1;
    /**
     * <p>This symbol is the offset where the {@link ai.foostack.sa_gui.R.attr#scopeUris}
     * attribute's value can be found in the {@link #SignInButton} array.
     *
     * <p>May be a reference to another resource, in the form
     * "<code>@[+][<i>package</i>:]<i>type</i>/<i>name</i></code>" or a theme
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ai.foostack.sa_gui:scopeUris
     */
